...
//import urlCard from "../assets/images/url-card.png";
//import urlDish from "../assets/images/url-dish.png"
      ...
      >
        ...
        >
          ...
          <div className="flex items-center flex-col gap-4 mt-4 ">
            <div className=" ">
              <img src="../assets/images/url-card.png" alt="" />
              {/* <img src={cardsvg} alt="" /> */}
            </div>
            <div>
              <img src="../assets/images/url-dish.png" alt="" />
              {/* <img src={dishsvg} alt="" /> */}
            </div>
          </div>
        </motion.div>
