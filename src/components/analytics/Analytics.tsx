...
//import analyticsLeft from "../../assets/images/analyticsLeft.png";
//import analyticsLeft from "../../assets/images/analyticLeft.png"
//import analyticsRight from "../../assets/images/analyticsRight.png";
        ...
        <motion.div
         ...
         >
          {/* find solution to the positioning */}
           <div>
            <img
             src="../../assets/images/analyticsLeft.png"
               alt="waves"
          ...
          <div>
            <img
              src="../../assets/images/analyticsRight.png"
              alt="waves"
            ...
            >
             ...
             <div className="flex justify-between w-full gap-2 text-blue-500">
              ...
              >
                  ...
                  <option value="lorem text">Custom Domain</option>
