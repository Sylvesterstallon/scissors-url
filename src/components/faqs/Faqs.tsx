...
//import faqsleft from "../../assets/images/faqsLeft.png"
//import faqsRight from "../../assets/images/faqsRight.png"
    ...
    return (
      <section id="faqs" className="w-full h-full p-10 relative">
        <div className="absolute bottom-0 right-0  w-1/4 h-1/4">
          <img src="../../assets/images/faqsRight.png" alt="faqs img" />
        </div>
        <div className="absolute top-0 left-0 w-1/4 h-1/4">
          <img src="../../assets/images/faqsLeft.png" alt="fAQS IMG" className="relative top-0 left-0" />
        </div>
        <motion.div
