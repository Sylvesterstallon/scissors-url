...
//import revolutionizingLeft from "../assets/images/revolutionizingLeft.png";
//import revolutionizingRight from "../assets/images/revolutionizingRight.png";
          ...
          <Faqs selectedPage={selectedPage} setSelectedPage={setSelectedPage} />
           <section className=" relative w-full h-full flex items-center justify-between flex-col gap-4 bg-background-blue py-10 text-white overflow-hidden">
             <div>
               ...
               <img
                src="../assets/images/revolutionizingLeft.png"
                alt="waves"
            ...
            <div>
              <img
                src="../assets/images/revolutionizingRight.png"
                alt="waves"
